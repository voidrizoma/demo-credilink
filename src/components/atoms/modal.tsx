  ...
  return (
    <div class="flex place-content-center bg-zinc-200 opacity-90 fixed inset-0 z-50">
      <div class="flex items-center h-screen">
        <div class={`flex m-3 p-4 justify-center items-center ${props.store?.isLoading ? "border-none" : "border-blue-500"} rounded-xl border-solid border-2 bg-white min-w-[200px] max-w-[300px] max-h-[300px]`}>
