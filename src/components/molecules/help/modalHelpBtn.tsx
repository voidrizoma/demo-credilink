    ...
    <>
      {props.textBoxState !== null && (
        <div
          ...
          style={{
            top: props.wHeight * props.sizePercentage * 1,
            left: 0,
            bottom: props.footerHeight / 2 + 15,
            ...
            {props.textBoxState.isOpen && (
              <div
                ...
                style={{
                  ...
                  height: props.wHeight * props.sizePercentage * 1,
                }}
              >

                <div class='flex flex-col gap-1 items-center w-full' style={{
                  height: props.wHeight * props.sizePercentage * 0.95,
                }}>
                  <div
                    id={`help-closeBtn`}
                    class='flex self-end'>
                  ...
                  {!itemStore.some(el => el.show == true) && <>
                    ...
                    <Text
                      ...
                      color="text-black"
                    />
                    <div class={`${props.wHeight > 800 ? 'h-[6px]' : 'h-[2px]'}`}></div>
                        ...
                        <>
                          ...
                          >
                            <img
                              ...
                              width={props.footerWidth * props.sizePercentage * (props.wHeight > 640 ? btnSizeFactor : btnSizeFactor * 0.7)}
                              src={itemStore[i].img}
                          ...
                          {el.name === 'whatsapp' &&
                            <div
                              ...
                              style={{ width: props.footerWidth * props.sizePercentage * (props.wHeight > 800 ? btnSizeFactor - 0.1 : btnSizeFactor + 0.2) }}
                            >
                              <Text
                                ...
                                color="text-black"
                              />
                              <a href="https://wa.me/525540819626?text=hola%2C%20tengo%20un%20problema%20con%20mi%20cr%C3%A9dito" target="_blank" class='hover:scale-[1.05]'>
                                <img
                                  id="help-wp"
                                  class={`self-center`}
                                  width={props.footerWidth * props.sizePercentage * (props.wHeight > 640 ? btnSizeFactor : btnSizeFactor * 0.7)}
                          ...
                          <div id='help-h25-' class={`${props.wHeight > 800 ? 'h-[25px]' : 'h-[15px]'}`}></div>
                        </>
                      ))}
                    </div>
                  </>}
